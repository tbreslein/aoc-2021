...
pub fn pick_challenge(day: i32, part: i32, file: String) -> Result<(), Box<dyn Error>> {
    ...
    match day {
        ...
        11 => match part {
            1 => println!("result = {}", solutions::day11::solve_p1(&data)),
            2 => println!("result = {}", solutions::day11::solve_p2(&data)),
            _ => println!("You chose part {}, but there only 2 parts per day!", part),
        },

        12 => match part {
            1 => println!("result = {}", solutions::day12::solve_p1(&data)),
            2 => println!("result = {}", solutions::day12::solve_p2(&data)),
            _ => println!("You chose part {}, but there only 2 parts per day!", part),
        },

        13 => match part {
            1 => println!("result = {}", solutions::day13::solve_p1(&data)),
            2 => println!("result = {}", solutions::day13::solve_p2(&data)),
            _ => println!("You chose part {}, but there only 2 parts per day!", part),
        },

        14 => match part {
            1 => println!("result = {}", solutions::day14::solve_p1(&data)),
            2 => println!("result = {}", solutions::day14::solve_p2(&data)),
            _ => println!("You chose part {}, but there only 2 parts per day!", part),
        },

        15 => match part {
            1 => println!("result = {}", solutions::day15::solve_p1(&data)),
            2 => println!("result = {}", solutions::day15::solve_p2(&data)),
            _ => println!("You chose part {}, but there only 2 parts per day!", part),
        },
